...
- struct `DeltaSpec` @ src/07_intention/UpsertPlan.jl:10
- struct `UpsertPlan` @ src/07_intention/UpsertPlan.jl:16
- fn `validate_plan` @ src/07_intention/UpsertPlan.jl:23
...
- fn `mask_to_bytes` @ src/07_intention/intent_lowering.jl:12
- fn `lower_intent_to_deltaspec` @ src/07_intention/intent_lowering.jl:16
