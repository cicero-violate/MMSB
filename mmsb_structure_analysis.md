...
- impl `Delta`					@ src/01_page/delta.rs:24
- fn `new_dense`				@ src/01_page/delta.rs:25
- fn `new_sparse`				@ src/01_page/delta.rs:52
- fn `merge`					@ src/01_page/delta.rs:80
- fn `to_dense`					@ src/01_page/delta.rs:118
- fn `apply_to`					@ src/01_page/delta.rs:134
- fn `now_ns`					@ src/01_page/delta.rs:151
...
- fn `cudaMallocManaged`		@ src/01_page/page.rs:16
- fn `cudaFree`					@ src/01_page/page.rs:17
- impl `PageLocation`			@ src/01_page/page.rs:32
- fn `from_tag`					@ src/01_page/page.rs:33
- struct `PageID`				@ src/01_page/page.rs:46
- impl `fmt`					@ src/01_page/page.rs:48
- fn `fmt`						@ src/01_page/page.rs:49
- struct `Metadata`				@ src/01_page/page.rs:56
- impl `Metadata`				@ src/01_page/page.rs:60
- fn `new`						@ src/01_page/page.rs:61
- fn `insert`					@ src/01_page/page.rs:67
- fn `clone_store`				@ src/01_page/page.rs:74
- fn `from_entries`				@ src/01_page/page.rs:78
- struct `Page`					@ src/01_page/page.rs:87
- impl `Page`					@ src/01_page/page.rs:98
- fn `new`						@ src/01_page/page.rs:99
- fn `size`						@ src/01_page/page.rs:152
- fn `location`					@ src/01_page/page.rs:156
- fn `data_slice`				@ src/01_page/page.rs:160
- fn `data_mut_slice`			@ src/01_page/page.rs:164
- fn `mask_slice`				@ src/01_page/page.rs:168
- fn `data_ptr`					@ src/01_page/page.rs:172
- fn `mask_ptr`					@ src/01_page/page.rs:176
- fn `epoch`					@ src/01_page/page.rs:180
- fn `set_epoch`				@ src/01_page/page.rs:184
- fn `metadata_entries`			@ src/01_page/page.rs:188
- fn `set_metadata`				@ src/01_page/page.rs:192
- fn `metadata_blob`			@ src/01_page/page.rs:196
- fn `set_metadata_blob`		@ src/01_page/page.rs:213
- fn `apply_delta`				@ src/01_page/page.rs:234
- impl `Clone`					@ src/01_page/page.rs:267
- fn `clone`					@ src/01_page/page.rs:268
- impl `Drop`					@ src/01_page/page.rs:295
- fn `drop`						@ src/01_page/page.rs:296
- fn `read_u32`					@ src/01_page/page.rs:343
- fn `read_bytes`				@ src/01_page/page.rs:354
...
- struct `LogSummary`			@ src/01_page/tlog.rs:24
- impl `TransactionLog`			@ src/01_page/tlog.rs:30
- fn `new`						@ src/01_page/tlog.rs:31
- fn `append`					@ src/01_page/tlog.rs:47
- fn `len`						@ src/01_page/tlog.rs:63
- fn `drain`					@ src/01_page/tlog.rs:67
- fn `current_offset`			@ src/01_page/tlog.rs:72
- impl `TransactionLogReader`	@ src/01_page/tlog.rs:87
- fn `open`						@ src/01_page/tlog.rs:88
- fn `next`						@ src/01_page/tlog.rs:95
- fn `free`						@ src/01_page/tlog.rs:99
- impl `Drop`					@ src/01_page/tlog.rs:102
- fn `drop`						@ src/01_page/tlog.rs:103
- fn `summary`					@ src/01_page/tlog.rs:106
- fn `serialize_frame`			@ src/01_page/tlog.rs:129
- fn `read_frame`				@ src/01_page/tlog.rs:152
- fn `validate_header`			@ src/01_page/tlog.rs:202
...
- fn `Delta`								@ src/01_page/Delta.jl:23
- fn `Delta`								@ src/01_page/Delta.jl:35
- fn `new_delta_handle`						@ src/01_page/Delta.jl:53
- fn `apply_delta`							@ src/01_page/Delta.jl:59
- fn `dense_data`							@ src/01_page/Delta.jl:63
- fn `serialize_delta`						@ src/01_page/Delta.jl:80
- fn `deserialize_delta`					@ src/01_page/Delta.jl:97
...
- fn `batch_route_deltas`					@ src/02_semiring/DeltaRouter.jl:68
- fn `propagate_change`						@ src/02_semiring/DeltaRouter.jl:86
- fn `propagate_change`						@ src/02_semiring/DeltaRouter.jl:91
...
- fn `vec_from_ptr`							@ src/ffi.rs:168
...
- fn `rust_checkpoint_write`				@ src/ffi/FFIWrapper.jl:352
- fn `rust_checkpoint_load`					@ src/ffi/FFIWrapper.jl:361
- fn `rust_allocator_page_infos`			@ src/ffi/FFIWrapper.jl:370
- fn `rust_allocator_acquire_page`			@ src/ffi/FFIWrapper.jl:385
- fn `rust_get_last_error`					@ src/ffi/FFIWrapper.jl:393
