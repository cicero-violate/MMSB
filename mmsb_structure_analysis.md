...
- fn `cudaMallocManaged`					@ src/01_page/page.rs:17
- fn `cudaFree`								@ src/01_page/page.rs:18
- impl `PageLocation`						@ src/01_page/page.rs:33
- fn `from_tag`								@ src/01_page/page.rs:34
- struct `PageID`							@ src/01_page/page.rs:47
- impl `fmt`								@ src/01_page/page.rs:49
- fn `fmt`									@ src/01_page/page.rs:50
- struct `Metadata`							@ src/01_page/page.rs:57
- impl `Metadata`							@ src/01_page/page.rs:61
- fn `new`									@ src/01_page/page.rs:62
- fn `insert`								@ src/01_page/page.rs:68
- fn `clone_store`							@ src/01_page/page.rs:75
- fn `from_entries`							@ src/01_page/page.rs:79
- struct `Page`								@ src/01_page/page.rs:88
- impl `Page`								@ src/01_page/page.rs:99
- fn `new`									@ src/01_page/page.rs:100
...
- impl `Drop`								@ src/01_page/page.rs:312
- fn `drop`									@ src/01_page/page.rs:313
- fn `read_u32`								@ src/01_page/page.rs:360
- fn `read_bytes`							@ src/01_page/page.rs:371
