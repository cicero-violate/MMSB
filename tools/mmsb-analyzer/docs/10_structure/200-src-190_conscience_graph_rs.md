# Structure Group: src/190_conscience_graph.rs

## File: src/190_conscience_graph.rs

- Layer(s): 190_conscience_graph.rs
...
- [Rust | Struct] `ConscienceStats` (line 0, pub)
  - Signature: `# [allow (dead_code)] pub struct ConscienceStats { pub total_functions : usize , pub protected_functions : usize , pu...`
