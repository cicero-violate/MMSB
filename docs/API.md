...
| `propagate_change!(state, page_id_or_vector; mode=IMMEDIATE)` | Notify dependents for a single page or a vector of pages (vector form merges duplicate edges/events).  |
