...
flowchart TD
    ...
    mmsb_allocator_allocate_1["macro eprintln"]
    mmsb_allocator_allocate_2["macro eprintln"]
    ...
    mmsb_allocator_allocate_15["macro eprintln"]
    mmsb_allocator_allocate_16["macro eprintln"]
    mmsb_allocator_allocate_17["PageHandle { ptr : page_ptr }"]
    mmsb_allocator_allocate_18["arm Err (_)"]
    mmsb_allocator_allocate_19["macro eprintln"]
...
flowchart TD
    ...
    mmsb_allocator_free_2["macro eprintln"]
...
flowchart TD
    ...
    mmsb_allocator_new_1["macro eprintln"]
    ...
    mmsb_allocator_new_6["macro eprintln"]
    mmsb_allocator_new_7["macro eprintln"]
...
flowchart TD
    ...
    mmsb_page_read_1["macro eprintln"]
    mmsb_page_read_2["macro eprintln"]
    mmsb_page_read_3["macro eprintln"]
    mmsb_page_read_4["macro eprintln"]
    mmsb_page_read_5["if handle . ptr . is_null ()"]
    mmsb_page_read_6["macro eprintln"]
    ...
    mmsb_page_read_24["macro eprintln"]
    ...
    mmsb_page_read_27["macro eprintln"]
