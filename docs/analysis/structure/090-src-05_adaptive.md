...
## File: MMSB/src/05_adaptive/AdaptiveLayout.jl
...
- [Julia | Module] `AdaptiveLayout` (line 9, pub)
- [Julia | Struct] `LayoutState` (line 22, pub)
  - Signature: `mutable struct LayoutState`
- [Julia | Function] `LayoutState` (line 29, pub)
  - Signature: `LayoutState(page_size::Int)`
  - Calls: LayoutState
- [Julia | Function] `optimize_layout!` (line 39, pub)
  - Signature: `optimize_layout!(state::LayoutState, access_pattern::Dict{Tuple{PageId, PageId}, Int})`
  - Calls: UInt64, collect, compute_locality_score, enumerate, get, hotness, isempty, keys, sort!, time
- [Julia | Function] `compute_locality_score` (line 72, pub)
  - Signature: `compute_locality_score(state::LayoutState, access_pattern::Dict{Tuple{PageId, PageId}, Int})`
  - Calls: Int, abs, get, isnothing

## File: MMSB/src/05_adaptive/EntropyReduction.jl
...
- [Julia | Module] `EntropyReduction` (line 7, pub)
- [Julia | Function] `compute_entropy` (line 19, pub)
  - Signature: `compute_entropy(access_frequencies::Dict{UInt64, Int})`
  - Calls: isempty, log2, sum, values
- [Julia | Function] `reduce_entropy!` (line 42, pub)
  - Signature: `reduce_entropy!(layout::Dict{UInt64, UInt64}, access_pattern::Dict{UInt64, Int}, page_size::Int)`
  - Calls: UInt64, collect, compute_entropy, enumerate, sort
- [Julia | Function] `entropy_gradient` (line 63, pub)
  - Signature: `entropy_gradient(access_pattern::Dict{UInt64, Int})`
  - Calls: log2, sum, values

## File: MMSB/src/05_adaptive/GraphRewriting.jl
...
- [Julia | Module] `GraphRewriting` (line 9, pub)
- [Julia | Struct] `EdgeRewrite` (line 21, pub)
  - Signature: `struct EdgeRewrite`
- [Julia | Function] `rewrite_dag!` (line 33, pub)
  - Signature: `rewrite_dag!(dag, frequency_map::Dict{Tuple{Int, Int}, Int})`
  - Calls: EdgeRewrite, can_reorder, collect, compute_edge_cost, keys, length, push!, reorderable, reordered
- [Julia | Function] `can_reorder` (line 71, pub)
  - Signature: `can_reorder(e1::Tuple{Int, Int}, e2::Tuple{Int, Int})`
- [Julia | Function] `compute_edge_cost` (line 84, pub)
  - Signature: `compute_edge_cost(edge::Tuple{Int, Int}, frequency_map::Dict{Tuple{Int, Int}, Int})`
  - Calls: Float64, get

## File: MMSB/src/05_adaptive/LocalityAnalysis.jl
...
- [Julia | Module] `LocalityAnalysis` (line 7, pub)
- [Julia | Struct] `AccessTrace` (line 16, pub)
  - Signature: `struct AccessTrace`
- [Julia | Struct] `LocalityMetrics` (line 26, pub)
  - Signature: `struct LocalityMetrics`
- [Julia | Function] `analyze_locality` (line 38, pub)
  - Signature: `analyze_locality(trace::AccessTrace, window_size::Int`
- [Julia | Function] `compute_reuse_distance` (line 77, pub)
